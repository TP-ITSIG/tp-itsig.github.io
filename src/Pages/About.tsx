		...
		<>
			...
			<VStack
				...
				<Text fontSize={{ base: "1em", lg: "1.25em" }}>
					...
					we made this website for IIT freshmen to provide resources
					for you to view in your free time before school starts so
					that you have a clearer idea of what to expect in your first
					semester with us.
				</Text>
				...
				<Text fontSize={{ base: "1em", lg: "1.25em" }} pt={-4}>
					...
					Information Technology. We plan events that improve the
					student life in our diploma. Such events include technical
					workshops to introduce new technology, coming up with
					diploma windbreakers, starting software projects like this
					website, and many more. Follow us on Instagram for more
					updates and we hope you learn a thing or two from our
					events! :)
				</Text>
			</VStack>
		</>
